...
======================================================================
ПОИСК ЗАВЕРШЁН
Всего итераций: 216,881
Время выполнения: 64.37 сек
Директория с результатами: particle_search_v2_20251204_181404

======================================================================
ЛУЧШЕЕ РЕШЕНИЕ:
Итерация: 216,880
Общая ошибка: 0.008754

МАССЫ:
  Протон: 937.185 МэВ (цель: 938.272)
  Нейтрон: 938.474 МэВ (цель: 939.565)
  Разность: 1.289 МэВ (цель: 1.293)

ЗАРЯДЫ:
  Протон: 1.000000 (цель: 1.0)
  Нейтрон: 0.000000 (цель: 0.0)

СПИНЫ:
  Протон: 0.5 (цель: 0.5)
  Нейтрон: 0.5 (цель: 0.5)
...
ОШИБКИ ПО КОМПОНЕНТАМ:
  mass_proton: 0.001159
  mass_neutron: 0.001161
  mass_diff: 0.002744
  charge_proton: 0.000000
  charge_neutron: 0.000000
  spin_proton: 0.000000
  spin_neutron: 0.000000
======================================================================

Графики сохранены в: particle_search_v2_20251204_181404/analysis.png

======================================================================
СТАТИСТИЧЕСКИЙ АНАЛИЗ ЛУЧШИХ РЕШЕНИЙ
======================================================================

Анализ топ-10 решений:

СРЕДНИЕ ЗНАЧЕНИЯ ПАРАМЕТРОВ:
  freq_u: 0.932120 ± 0.012570
  amp_u: 0.990412 ± 0.017320
  freq_d: 0.902166 ± 0.004141
  amp_d: 0.909957 ± 0.007310
  coupling: 1.307231 ± 0.059308
...
РЕКОМЕНДАЦИИ:
  1. Частоты u и d нитей должны быть близки (отношение ~1.0-1.1)
  2. Амплитуды около 1.0, возможно с небольшим преобладанием u-нити
  3. Сила связи в диапазоне 1.5-2.5
  4. Для разности масс важно точное соотношение параметров d и u нитей
